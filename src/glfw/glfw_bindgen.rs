...
#[doc = "  @param[in] maximized `GLFW_TRUE` if the window was maximized, or"]
#[doc = "  `GLFW_FALSE` if it was restored."]
#[doc = ""]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @remark @macos This function will create the main menu and dock icon for the"]
    #[doc = "  application.  If GLFW finds a `MainMenu.nib` it is loaded and assumed to"]
    #[doc = "  contain a menu bar.  Otherwise a minimal menu bar is created manually with"]
    #[doc = "  common commands like Hide, Quit and About.  The About entry opens a minimal"]
    #[doc = "  about dialog with information from the application's bundle.  The menu bar"]
    #[doc = "  and dock icon can be disabled entirely with the @ref GLFW_COCOA_MENUBAR init"]
    #[doc = "  hint."]
    #[doc = ""]
    #[doc = "  @remark @x11 This function will set the `LC_CTYPE` category of the"]
    #[doc = "  application locale according to the current environment if that category is"]
    #[doc = "  still \"C\".  This is because the \"C\" locale breaks Unicode text input."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = "  failure."]
    #[doc = ""]
    #[doc = "  This function has no effect if GLFW is not initialized."]
    #[doc = ""]
    #[doc = "  @errors Possible errors include @ref GLFW_PLATFORM_ERROR."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @remark @macos The OS only supports core profile contexts for OpenGL"]
    #[doc = "  versions 3.2 and later.  Before creating an OpenGL context of version 3.2 or"]
    #[doc = "  later you must set the [GLFW_OPENGL_PROFILE](@ref GLFW_OPENGL_PROFILE_hint)"]
    #[doc = "  hint accordingly.  OpenGL 3.0 and 3.1 contexts are not supported at all"]
    #[doc = "  on macOS."]
    #[doc = ""]
    ...
    #[doc = "  `CMake/Info.plist.in` in the source tree."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref"]
    #[doc = "  GLFW_PLATFORM_ERROR and @ref GLFW_FEATURE_UNAVAILABLE (see remarks)."]
    #[doc = ""]
    #[doc = "  @pointer_lifetime The specified image data is copied before this function"]
    #[doc = "  returns."]
    #[doc = ""]
    #[doc = "  @remark @macos Regular windows do not have icons on macOS.  This function"]
    #[doc = "  will emit @ref GLFW_FEATURE_UNAVAILABLE.  The dock icon will be the same as"]
    ...
    #[doc = "  This function will emit @ref GLFW_FEATURE_UNAVAILABLE."]
    #[doc = ""]
    #[doc = "  @thread_safety This function must only be called from the main thread."]
    #[doc = ""]
    #[doc = "  @sa @ref window_icon"]
...
extern "C" {
    ...
    #[doc = "  position of its windows.  This function will emit @ref"]
    #[doc = "  GLFW_FEATURE_UNAVAILABLE."]
    #[doc = ""]
    #[doc = "  @thread_safety This function must only be called from the main thread."]
    #[doc = ""]
    #[doc = "  @sa @ref window_pos"]
...
extern "C" {
    ...
    #[doc = "  GLFW_PLATFORM_ERROR and @ref GLFW_FEATURE_UNAVAILABLE (see remarks)."]
    #[doc = ""]
    #[doc = "  @remark @wayland There is no way to set an opacity factor for a window."]
    #[doc = "  This function will emit @ref GLFW_FEATURE_UNAVAILABLE."]
    #[doc = ""]
    #[doc = "  @thread_safety This function must only be called from the main thread."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = "  GLFW_PLATFORM_ERROR."]
    #[doc = ""]
    #[doc = "  @remark @wayland Once a window is iconified, @ref glfwRestoreWindow won’t"]
    #[doc = "  be able to restore it.  This is a design decision of the xdg-shell"]
    #[doc = "  protocol."]
    #[doc = ""]
    #[doc = "  @thread_safety This function must only be called from the main thread."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = "  GLFW_PLATFORM_ERROR and @ref GLFW_FEATURE_UNAVAILABLE (see remarks)."]
    #[doc = ""]
    #[doc = "  @remark @wayland It is not possible for an application to set the input"]
    #[doc = "  focus.  This function will emit @ref GLFW_FEATURE_UNAVAILABLE."]
    #[doc = ""]
    #[doc = "  @thread_safety This function must only be called from the main thread."]
    #[doc = ""]
    #[doc = "  @sa @ref window_focus"]
...
extern "C" {
    ...
    #[doc = "  [GLFW_MOUSE_PASSTHROUGH](@ref GLFW_MOUSE_PASSTHROUGH_attrib)"]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = "  attempting to set this will emit @ref GLFW_FEATURE_UNAVAILABLE.  Call @ref"]
    ...
    #[doc = ""]
    #[doc = "  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref"]
    #[doc = "  GLFW_INVALID_ENUM, @ref GLFW_PLATFORM_ERROR and @ref"]
    #[doc = "  GLFW_FEATURE_UNAVAILABLE (see above)."]
    #[doc = ""]
    #[doc = "  @thread_safety This function must only be called from the main thread."]
    #[doc = ""]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = "  Returns a cursor with a standard shape, that can be set for a window with"]
    #[doc = "  @ref glfwSetCursor.  The images for these cursors come from the system"]
    #[doc = "  cursor theme and their exact appearance will vary between platforms."]
    #[doc = ""]
    #[doc = "  Most of these shapes are guaranteed to exist on every supported platform but"]
    #[doc = "  a few may not be present.  See the table below for details."]
    #[doc = ""]
    #[doc = "  Cursor shape                   | Windows | macOS | X11    | Wayland"]
    #[doc = "  ------------------------------ | ------- | ----- | ------ | -------"]
    #[doc = "  @ref GLFW_ARROW_CURSOR         | Yes     | Yes   | Yes    | Yes"]
    #[doc = "  @ref GLFW_IBEAM_CURSOR         | Yes     | Yes   | Yes    | Yes"]
    #[doc = "  @ref GLFW_CROSSHAIR_CURSOR     | Yes     | Yes   | Yes    | Yes"]
    #[doc = "  @ref GLFW_POINTING_HAND_CURSOR | Yes     | Yes   | Yes    | Yes"]
    #[doc = "  @ref GLFW_RESIZE_EW_CURSOR     | Yes     | Yes   | Yes    | Yes"]
    #[doc = "  @ref GLFW_RESIZE_NS_CURSOR     | Yes     | Yes   | Yes    | Yes"]
    #[doc = "  @ref GLFW_RESIZE_NWSE_CURSOR   | Yes     | Yes<sup>1</sup> | Maybe<sup>2</sup> | Maybe<sup>2</sup>"]
    #[doc = "  @ref GLFW_RESIZE_NESW_CURSOR   | Yes     | Yes<sup>1</sup> | Maybe<sup>2</sup> | Maybe<sup>2</sup>"]
    #[doc = "  @ref GLFW_RESIZE_ALL_CURSOR    | Yes     | Yes   | Yes    | Yes"]
    #[doc = "  @ref GLFW_NOT_ALLOWED_CURSOR   | Yes     | Yes   | Maybe<sup>2</sup> | Maybe<sup>2</sup>"]
    #[doc = ""]
    #[doc = "  1) This uses a private system API and may fail in the future."]
    #[doc = ""]
    #[doc = "  2) This uses a newer standard that not all cursor themes support."]
    #[doc = ""]
    #[doc = "  If the requested shape is not available, this function emits a @ref"]
    #[doc = "  GLFW_CURSOR_UNAVAILABLE error and returns `NULL`."]
    #[doc = ""]
    ...
    #[doc = ""]
    #[doc = "  @errors Possible errors include @ref GLFW_NOT_INITIALIZED, @ref"]
    #[doc = "  GLFW_INVALID_ENUM, @ref GLFW_CURSOR_UNAVAILABLE and @ref"]
    #[doc = "  GLFW_PLATFORM_ERROR."]
    #[doc = ""]
    #[doc = "  @thread_safety This function must only be called from the main thread."]
    #[doc = ""]
    #[doc = "  @sa @ref cursor_standard"]
